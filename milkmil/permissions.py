...
class CanWriteGuest(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        if 14 in user_permissions or 1 in user_permissions:
            return True
        return False
...
class CanWriteVehicle(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        for i in perms:
            user_permissions.append(i.id)
        if 14 in user_permissions or 11 in user_permissions or 1 in user_permissions:
            return True
        return False
...
class CanWriteMasterData(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        for i in perms:
            user_permissions.append(i.id)
        if 1 in user_permissions or 1 in user_permissions:
            return True
        return False
...
class CanViewReport(BasePermission):
    ...
    def has_permission(self, request, view):
        ...
        for i in perms:
            user_permissions.append(i.id)
        if 13 in user_permissions or 1 in user_permissions:
            return True
        return False
